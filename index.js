...
+ 'FN:Ketzakot\n' // Nama
+ 'ORG:BOTCITO;\n' // Nama bot
+ 'TEL;type=CELL;type=VOICE;waid=573508419687:+573508419687\n' // Nomor bot
+ 'END:VCARD' 
...
Usa ${prefix}verify para verificarte y poder usar el bot.`
				...
				num = anu.participants[0]
				teks = `menos mal te fuiste ya t queria sacar @${num.split('@')[0]} ni buelvas 😹`
				Lxa.sendMessage(mdata.id, teks, MessageType.text, {contextInfo: {"mentionedJid": [num]}})
			}
		} catch (e) {
  ...
  error: {
  stick: 'Chale algo fallo Intentalo al rato :(',
  Iv: 'Nmms pon el link bien'
  },
  only: {
